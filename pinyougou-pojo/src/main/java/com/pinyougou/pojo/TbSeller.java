...
public class TbSeller implements Serializable{
	...
	public String toString() {
		return "TbSeller [sellerId=" + sellerId + ", name=" + name + ", nickName=" + nickName + ", password=" + password
				+ ", email=" + email + ", telephone=" + telephone + ", status=" + status + ", addressDetail="
				+ addressDetail + ", linkmanName=" + linkmanName + ", linkmanQq=" + linkmanQq + ", linkmanMobile="
				+ linkmanMobile + ", linkmanEmail=" + linkmanEmail + ", licenseNumber=" + licenseNumber + ", taxNumber="
				+ taxNumber + ", orgNumber=" + orgNumber + ", address=" + address + ", logoPic=" + logoPic + ", brief="
				+ brief + ", createTime=" + createTime + ", legalPerson=" + legalPerson + ", legalPersonCardId="
				+ legalPersonCardId + ", bankUser=" + bankUser + ", bankName=" + bankName + "]";
	}
